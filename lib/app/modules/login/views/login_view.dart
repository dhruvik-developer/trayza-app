...
class LoginView extends GetView<LoginController> {
  ...
  Widget build(BuildContext context) {
    return GetX<BusinessProfileService>(
      builder: (_) {
          ...
          body: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  isDark ? AppColors.backgroundDark : const Color(0xFFF1F7FF),
                  isDark ? const Color(0xFF131C31) : Colors.white,
                ],
              ),
            ),
            child: Stack(
              children: [
                ...
                _buildBackgroundOrb(
                  ...
                  size: 180,
                  color:
                      AppColors.primary.withValues(alpha: isDark ? 0.10 : 0.08),
                ),
                _buildBackgroundOrb(
                  bottom: -90,
                  left: 30,
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      final horizontalPadding =
                          constraints.maxWidth < 600 ? 24.0 : 32.0;
