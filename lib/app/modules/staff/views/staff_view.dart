            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  ...
                  return Expanded(
                    child: isMobile ? _buildStaffList() : _buildStaffTable(),
                  );
                }),
              ],
            ),
        ...
        Row(
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text("Event Staff",
                    style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: AppColors.textPrimary)),
                Obx(() => Text(
                    "${controller.staffList.length} staff registered",
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: Text("₹${staff.salary?.toStringAsFixed(0) ?? '0'}",
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
            colors: [AppColors.primary, Color(0xFFAC94F4)],
        ...
        return Card(
          ...
          child: ListTile(
            ...
            title: Text(staff.name ?? "N/A",
                style: const TextStyle(fontWeight: FontWeight.bold)),
            subtitle:
                Text("${staff.role ?? 'No Role'} • ${staff.type ?? 'Fixed'}"),
            trailing:
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
              onPressed: controller.goToAddStaff,
              child: const Text("Register First Staff")),
        ],
      ),
    );
  }
